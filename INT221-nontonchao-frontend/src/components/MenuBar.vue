...
<template>
    <div class="flex bg-main p-5 font-mitr justify-between w-auto">
        <div class="flex ">
        ...
        <div class="flex mr-12">
            <router-link
                class="text-3xl font-bold py-2 px-4 rounded-3xl hover:text-white drop-shadow-2xl transform  text-white   delay-50 hover:-translate-y-1  duration-300 ..."
