      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="text-left leading-8 p-5 flex-auto justify-center pb-12">
          <div class="w-full md:w-full px-3 mb-6 md:mb-0 ">
            <label class="flex ">
              <p>ชื่อหมวดหมู่ :</p>
              <input type="text" v-model="tmp.eventCategoryName" class="form-control block mx-4 w-3/5 px-2 py-1.5 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
            </label>
