...
<template>
  <div class="w-full max-w-lg md:w-3/5 px-6 mb-8 container mx-auto content-center leading-8">
    <div>
      ...
      <div class="w-full md:w-full px-3 mb-6 md:mb-0">
        <label class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2 m-3" for="grid-email">Email:
        </label>
      ...
      <div class="w-full md:w-full px-3 mb-6 md:mb-0">
        ...
        <input type="datetime-local" v-model="startTime" required :min="startTime"
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
      </div>
    </div>
    <div class="w-full m-5 md:w-full px-3 mb-8 md:mb-0">
      <button @click="toggleQue()" :disabled="isFullfill()"
        class="bg-main p-5 hover:text-black hover:bg-acqua text-white font-bold py-2 px-4 rounded-full" type="button">
        นัดหมาย
      </button>
    </div>
  </div>
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-6 space-y-6">
          <h3 class="text-base leading-relaxed text-yellow-300 dark:text-gray-400">
